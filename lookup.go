...
import (
	...
	"github.com/laincat/GeoIP/plugin/ipinfo"
	"github.com/laincat/GeoIP/plugin/maxmind"
	"github.com/laincat/GeoIP/plugin/plaintext"
	"github.com/laincat/GeoIP/plugin/special"
...
func getInputForLookup(format, name, uri, dir string) lib.InputConverter {
	...
	case strings.ToLower(ipinfo.TypeCountryCSV):
		input = &ipinfo.CountryCSVIn{
			Type:        ipinfo.TypeCountryCSV,
			Action:      lib.ActionAdd,
			Description: ipinfo.DescCountryCSV,
			URI:         uri,
		}
